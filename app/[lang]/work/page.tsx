        ...
        <section aria-labelledby="featured-work" className="mt-12">
          <Container>
            ...
            <Link
              ...
              className="mt-4 grid overflow-hidden rounded-3xl border border-slate-200 bg-white hover:shadow-xl motion-safe:transition-all motion-safe:duration-200 dark:border-slate-800 dark:bg-slate-900 md:grid-cols-2"
            >
              <div className="flex flex-col justify-center p-8 sm:p-10">
                ...
                <h2 id="featured-work" className="mt-3 text-2xl font-extrabold tracking-tight dark:text-white sm:text-3xl">{pick(featured.title, lang)}</h2>
                ...
                <span className="mt-6 inline-flex items-center gap-1.5 text-sm font-bold text-brand-700 dark:text-brand-100">
                  {dict.workPage.viewCaseStudy} <span aria-hidden="true">→</span>
                </span>
              </div>
